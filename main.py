...
def send_email(email):
    ...
    body = "Dear candidate, you have been invited for an interview. Be prepared. Your interview will start at 4:00 pm today. Location: 123 Street Lahore Pakistan.\n From jobocde, /n Deeba Umar."
    try:
...
def get_data():
    ...
    data = obj.fetchData()
    for i in data:
        row = {"name": i[1], "subject": i[2], "cgpa": i[3], "institute": i[4], "bio": i[5]}
